...
- **[organize-files-by-content](https://github.com/gegezi1205/organize-files-by-content)** — 按文件内容和用途整理文件夹的 skill：先简短问询职业与查找习惯，沿用现有目录规律给出整理方案，完整预览确认后才改名/移动，拿不准的文件留在原处。（中英文双语）
  **什么时候用：** 桌面、下载目录或工作文件夹堆积混乱，想让 Agent 安全整理、又担心换套陌生目录后自己找不到文件时。
  **作者：** [@gegezi1205](https://github.com/gegezi1205)　**标签：** `文件整理` `办公自动化` `预览确认` `中英文`
